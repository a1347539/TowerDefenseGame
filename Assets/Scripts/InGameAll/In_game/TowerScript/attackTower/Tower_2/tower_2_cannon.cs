...
public class tower_2_cannon : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        parent_tower = transform.parent.parent.gameObject.GetComponent<Tower>();
    }

    private void Start()
    {
        GetComponent<SpriteRenderer>().sortingOrder = parent_tower.GetComponent<Tower>().sortingOrder + 30;
    }
